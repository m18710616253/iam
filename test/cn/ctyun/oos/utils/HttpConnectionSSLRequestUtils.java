...
public class HttpConnectionSSLRequestUtils {

public static HttpsURLConnection createhttpsConn(URL url, String method, Map<String, String> headers) throws Exception{
