 ...
 *
 */
public class AccountPasswordPolicyTestDev {
    ...
    // 用户名
    String policyName = "CreateGroupPolicyForA2";
    String userName = "CreateGroupUserForStrinA2";
    String createGroupName = "testCreateGroupForA2";
    ...
    public void testUserAllow() throws Exception {
        ...
        statement.actions.add("iam:UpdateAccountPasswordPolicy");
        statement.resources.add("arn:ctyun:iam::17vdu0cyjo7rh:*");
        ...
        // 无权限请求失败
        body = "Action=UpdateAccountPasswordPolicy&Version=2010-05-08";
        ...
        // 有权限请求成功
        body = "Action=UpdateAccountPasswordPolicy&Version=2010-05-08&GroupName=" + createGroupName;
        resultPair = IAMTestUtils.invokeHttpsRequest(body, accessKeyResult.accessKeyId, accessKeyResult.secretAccessKey);
        assertEquals(200, resultPair.first().intValue());
    ...
    public void testUserDeny() throws Exception {
        ...
        // 添加条件
        Condition condition = new StringCondition("StringEqualsIgnoreCase", "ctyun:username", Arrays.asList("C1"));
        statement.conditions.add(condition);
        condition = new StringCondition("StringLike", "ctyun:username", Arrays.asList("User"));
        statement.conditions.add(condition);
        condition = new StringCondition("StringLike", "ctyun:username", Arrays.asList("xxxx"));
        statement.conditions.add(condition);
        accessPolicy.statements.add(statement);
