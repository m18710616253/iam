 ...
 *
 */
public class StringConditionTestDev {
    ...
    // 用户名
    String policyName = "CreateGroupPolicyForStringC4";
    String userName = "CreateGroupUserForStringC4";
    String createGroupName = "testCreateGroupForStringC4";
    ...
    public void testUserAllow() throws Exception {
        ...
        // 添加条件
        Condition condition = new StringCondition("StringLike", "ctyun:username", Arrays.asList("*User*"));
