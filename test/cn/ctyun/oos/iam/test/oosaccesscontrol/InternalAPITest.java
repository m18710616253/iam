...
//        assertEquals(21, responseJsonObject.getInt("groupsQuota")); 
    ...
    public void test_OOSPolicy_CreatePolicy() throws Exception{
        ...
        assertNotNull(jo.getInt("createDate"));
        assertNotNull(jo.getInt("updateDate"));
        assertEquals(jo.getInt("createDate"), jo.getInt("updateDate"));
...
//        assertEquals("policyNameEmpty", jo.getJSONArray("errorMessages").getJSONObject(0).getString("messageCode"));
    ...
    @Test
    /*
     * 创建用户名不同，policyDocument一样的系统策略
     */
    public void test_OOSPolicy_CreatePolicy_samePolicyDocument() {
        
    }
    
    
    
    public void test_OOSPolicy_UpdatePolicy() {
        
    }
    
    @Test
    public void test_OOSPolicy_UpdatePolicy_noParamPolicyName() {
        
    }
    
    @Test
    public void test_OOSPolicy_UpdatePolicy_noParamPolicyDocument() {
        
    }
    
    @Test
    public void test_OOSPolicy_UpdatePolicy_noParamDescription() {
        
    }
    
    @Test
    public void test_OOSPolicy_UpdatePolicy_PolicyNameEmtpy() {
        
    }
    
    @Test
    public void test_OOSPolicy_UpdatePolicy_PolicyDocumentEmpty() {
        
    }
    
    @Test
    public void test_OOSPolicy_UpdatePolicy_DescriptionEmpty() {
        
    }
    
    @Test
    public void test_OOSPolicy_UpdatePolicy_PolicyNameError() {
        
    }
    
    @Test
    public void test_OOSPolicy_UpdatePolicy_PolicyDocumentError() {
     ...
     * 系统策略不存在
     */
    public void test_OOSPolicy_UpdatePolicy_PolicyNotExist() {
     ...
     * 系统策略不存在,但自定义策略存在
     */
    public void test_OOSPolicy_UpdatePolicy_PolicyNotExist2() {
        
    }
    
    
    public void test_OOSPolicy_DeletePolicy() {
        
    }
    
    public void test_OOSPolicy_DeletePolicy_NoParamPolicyName() {
        
    }
    
    public void test_OOSPolicy_DeletePolicy_PolicyNameEmpty() {
     ...
     * 系统策略不存在
     */
    public void test_OOSPolicy_DeletePolicy_PolicyNotExist() {
     ...
     * 系统策略不存在，自定义策略存在
     */
    public void test_OOSPolicy_DeletePolicy_PolicyNotExist2() {
     ...
     */
    public void test_OOSPolicy_DeletePolicy_PolicyAttachUser() {
        
    }
    
    public void test_OOSPolicy_GetPolicy() {
        
    }
    
    
    
    public void test_OOSPolicy_GetPolicy_NoParamPolicyName() {
        
    }
    
    public void test_OOSPolicy_GetPolicy_PolicyNameEmpty() {
     ...
     * 系统策略不存在
     */
    public void test_OOSPolicy_GetPolicy_PolicyNotExist() {
     ...
     * 系统策略不存在，自定义策略存在
     */
    public void test_OOSPolicy_GetPolicy_PolicyNotExist2() {
        
    }
    
    
    public void test_OOSPolicy_ListPolicies() {
        
    }
    
    public void test_OOSPolicy_ListPolicies_NoParamPolicyName() {
        
    }
    
    public void test_OOSPolicy_ListPolicies_policyNameEmpty() {
        
    }
    
    public void test_OOSPolicy_ListPolicies_MaxItemsNoValue() {
        
    }
    
    public void test_OOSPolicy_ListPolicies_MaxItems0() {
        
    }
    
    public void test_OOSPolicy_ListPolicies_MarkerNoValue() {
        
    }
    
    public void test_OOSPolicy_ListPolicies_Marker0() {
        
    }
    
    public void test_OOSPolicy_ListPolicies_MaxItems5MarkerNormal() {
